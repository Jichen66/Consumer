...
import com.huawei.mlkit.example.imgseg.ImageSegmentationAnalyseActivity;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.findViewById(R.id.btn_imageseg).setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_productvisionsearch:
                ...
                break;
            case R.id.btn_imageseg:
                this.startActivity(new Intent(MainActivity.this, ImageSegmentationAnalyseActivity.class));
                break;
            case R.id.btn_icr:
