...
public class ImageSegmentationAnalyseActivity extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = ImageSegmentationAnalyseActivity.class.getSimpleName();
        ...
        task.addOnSuccessListener(new OnSuccessListener<MLImageSegmentation>() {
            ...
            public void onSuccess(MLImageSegmentation imageSegmentationResult) {
                ...
                if (imageSegmentationResult != null) {
                    ImageSegmentationAnalyseActivity.this.displaySuccess(imageSegmentationResult);
                } else {
                    ImageSegmentationAnalyseActivity.this.displayFailure();
                }
            }
    ...
    protected void onDestroy() {
        ...
        if (this.analyzer != null) {
            try {
                ...
                Log.e(ImageSegmentationAnalyseActivity.TAG, "Stop failed: " + e.getMessage());
            }
        }
    }
}
