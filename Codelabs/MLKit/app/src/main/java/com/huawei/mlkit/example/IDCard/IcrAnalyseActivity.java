...
public class IcrAnalyseActivity extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "IcrAnalyse";
    ...
    private void remoteAnalyzer() {
        ...
        task.addOnSuccessListener(new OnSuccessListener<MLIdCard>() {
            ...
            public void onFailure(Exception e) {
                // Recognition failure.
                IcrAnalyseActivity.this.displayFailure();
            }
        });
    }
     ...
     * @param isRemote Whether to use the on-cloud model, this parameter is always false when using the pre-processing plug-in scenario.
     */
